...
class Config(object):
    ...
    def set_port(self, section, port):
        self.__port = self.__config.get(section, port)
    ...
    def set_file_name_config(self, section, date_and_time):
        self.__filename = "{0}-{1}".format(section, date_and_time)
    ...
    def set_all_variables_from_config(self, section):
        # self.set_enable_stop_services('DEFAULT', 'enable_stop_services')
        # self.set_command_stop('DEFAULT', 'command_services_stop')
        # self.set_command_start('DEFAULT', 'command_services_start')
        self.set_server_name('DEFAULT', 'server_name')
        self.set_type_config(section, 'type_backup')
        self.set_folder_config(section, 'folder_backup')
        self.set_folder_dest_config(section, 'folder_dest')
        self.set_time_keep(section, 'time_keep')
        self.set_remote_share_config(section, 'remote_share')
        self.set_host_config(section, 'host')
        self.set_port(section, 'port')
        self.set_user_config(section, 'user')
        self.set_password_config(section, 'password')
        self.set_database(section, 'database')
        self.set_bucket_name_config(section, 'bucket_name')
        self.set_access_key_config(section, 'access_key')
        self.set_secret_access_key(section, 'secret_access_key')
        self.set_file_name_config(section, time.strftime('%Y-%m-%d-%H'))
        self.set_exclude_list_file(section, 'exclude_list_file')
